...
let subset_test3 = subset [4;5;1;1] [1;3;4;5;6]
let subset_test4 = subset [1;1;1;3] [1;3]

let equal_sets_test0 = equal_sets [1;3] [3;1;3]
let equal_sets_test1 = not (equal_sets [1;3;4] [3;1;3])
let equal_sets_test2 = equal_sets [4;4;5;5;6] [4;5;6]
let equal_sets_test3 = equal_sets [4;5;6] [4;4;5;5;6]
...
let set_union_test3 = equal_sets (set_union [1;1;1] [4;5;6]) [1;4;5;6]
...
let set_intersection_test3 =
  equal_sets (set_intersection [1;2;2] [2]) [2]
...
let set_diff_test4 = equal_sets (set_diff [5] [1;2;3]) [5]
...
let computed_fixed_point_test4 = 
  (fun x y -> abs_float(x -. y) < 0.00001) ((computed_fixed_point (fun x y -> abs_float (x -. y) < 0.0001) sin 5.0)) (-0.0842888611883808175)
...
let computed_periodic_point_test2 =
  (  (fun x y -> abs_float(x -. y) < 0.00001))(computed_periodic_point (fun x y -> abs_float(x -. y) < 0.0001) (fun x -> sqrt x) 1 10.) 1.00014054851694723

let while_away_test1 = 
  equal_sets (while_away ((+) 3) ((>) 10) 0) [0; 3; 6; 9]
let while_away_test2 = equal_sets (while_away ((-) 3) ((<) 0) 10) [10]
